#how the binary coversation is handelling in the python using XOR
import os
os.system("cls")
...
print( "if we are using the 'Xor' operator we see that there are many diffrence in the data int or any thing example 12 & 26  what we expect ?? i will leave it to you")
