...
print(main.__code__.co_name)#constant will show the constant of the function
print(results.__code__.co_name)#constant will show the constant of the function
