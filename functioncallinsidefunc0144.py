...
def functiontwo():
	""" we are starting the function 
	"""
    functionone() # we are calling the function here in the this module will go to the function one (this is called chaining function)
...
print("we are calling the function from the below we are going to the 34 line here returning from 39", end="\n")
functiontwo()
print("this out of loop", end="\n\n")
time.sleep(3)
