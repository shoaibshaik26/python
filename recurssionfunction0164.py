...
def mytfunction(valuestart,value):
    if valuestart <= value:
        print(valuestart*valuestart, end=","if valuestart < value else "\n")
        valuestart+=1
        mytfunction(valuestart,value) #here the function is calling it self and we can state the recursion here
