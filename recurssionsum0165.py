...
def mytfunction(valuestart,value):
    if valuestart>value:
        ...
        sumoftotal = valuestart+1
        currentvalue =mytfunction(sumoftotal,value)
        returnvalue = valuestart+ currentvalue
        #print(returnvalue, end="\n")
        return returnvalue
         #here the function is calling it self and we can state the recursion here
...
values = mytfunction(valuestart,value)
print(values)